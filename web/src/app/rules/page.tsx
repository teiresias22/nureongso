  ...
  return (
    <div className="space-y-6">
      ...
      <Box title="7. 같은 선거구 후보와 공약 비교">
        ...
        <p className="text-muted">
          표본 33쌍을 사람이 직접 읽어 확인했습니다. <b>27쌍은 분명히 같은 약속</b>이었고,
          6쌍은 두 공약이 모두 포괄적이어서 느슨하게 이어졌습니다. 잘못 이어진 것은 없었지만,
          느슨한 쌍이 섞일 수 있다는 뜻입니다. 이 비교는 <b>이행 판정에 쓰지 않습니다</b> —
          누가 무엇을 약속했는지 보여줄 뿐, 잘잘못을 가리지 않습니다.
        </p>
      </Box>
